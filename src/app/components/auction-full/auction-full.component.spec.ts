...
import { AuctionFullComponent } from './auction-full.component';
...
describe('AuctionFullComponent:', () => {
  let component: AuctionFullComponent;
  let fixture: ComponentFixture<AuctionFullComponent>;
  ...
  beforeEach(async(() => {
    TestBed.configureTestingModule({
      ...
      .compileComponents()
      .then(() => {
        fixture = TestBed.createComponent(AuctionFullComponent);
  ...
  describe('Unit Tests:', () => {
    ...
    it('should have a title attribute with value Auction - No Pagination', () => {
      expect(component.title).toBe('Auction - No Pagination');
    });
  ...
  describe('UI Tests: ', () => {
    ...
    it('should render title in a h2 tag and contain value Auction - No Pagination', () => {
      vehiclesElement = fixture.nativeElement;
      expect(vehiclesElement.querySelector('h2').textContent).toContain('Auction - No Pagination'); /*?.*/
    });
